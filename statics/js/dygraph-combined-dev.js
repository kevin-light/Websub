...
// TODO(danvk): most of these should just stay in the attrs_ dictionary.
                    ...
                    this.resetWindow_ = attrs.dateWindow || null;
...
// Plugin instances contain an activate method.
                        ...
                        var pluginDict = {plugin: pluginInstance, events: {}, options: {}, pluginOptions: {}};
...
// right. h needs to be precisely the plot area, so that clipping occurs.
                 ...
                 */Dygraph.prototype.createRollInterface_ = function () {
                    ...
                    var textAttr = {"top": area.y + area.h - 25 + "px", "left": area.x + 1 + "px", "display": display};
                    roller.size = "2";
...
// coordinates increase as you go up the screen.
                 ...
                 */Dygraph.prototype.resetZoom = function () {
                    ...
                    var _xAxisExtremes = this.resetWindow_;
                    ...
                    if (!animatedZooms) {
                        ...
                        this.dateWindow_ = this.resetWindow_;
...
// independent ticks, then that is permissible as well.
                ...
                Dygraph.prototype.setXAxisOptions_ = function (isDate) {
                    if (isDate) {
                        ...
                        /** @private (shut up, jsdoc!) */this.attrs_.xValueParser = function (x) {
                            return parseFloat(x);
                        }; // TODO(danvk): use Dygraph.numberValueFormatter here?
                        /** @private (shut up, jsdoc!) */this.attrs_.axes.x.valueFormatter = function (x) {
                            return x;
                        };
